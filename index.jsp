        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.jsp"><span style="color: blue;">V</span><span style="color: pink;">V</span><span class="text-primary">App</span><span class="text-primary">.</span></a>
            </div>
...
<!--                   <li><a href="blog.jsp" class="nav-link">Blog</a></li> -->
              ...
              <div class="top-social ml-auto">
              	<a href="login.jsp" class="nav-link" style="color: blue;">Login</a>
        ...
        <div class="container">
          <div class="row align-items-center ">
            <div class="col-md-5 mt-5 pt-5">
              ...
              <p>We Provide Wallet services between Customer and Retailer, Transactions will be done from Customer and receive cashback accordingly as per Terms.</p>
              <p class="mt-5"><a href="about.jsp" class="btn btn-primary">About Us</a></p>
            </div>
            <div class="col-md-6 ml-auto">
              <div class="white-dots">
                <img src="images/VVApp_logo.png" alt="" class="img-fluid" width="540" height="385.7">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-12 text-center">
            <a href="services.jsp" class="btn btn-primary">View All Services</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-7 text-center mb-5">
            ...
            <p><a href="contact.jsp" class="btn btn-primary">Contact Us Now</a></p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <h2><a href="single.jsp">Lorem ipsum dolor sit amet</a></h2>
